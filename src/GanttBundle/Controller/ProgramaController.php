...
use GanttBundle\Entity\Programa;
...
class ProgramaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $programas = $em->getRepository('GanttBundle:Programa')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('GanttBundle\Form\ProgramaType', $programa);
    ...
    {
        $deleteForm = $this->createDeleteForm($programa);
        $editForm = $this->createForm('GanttBundle\Form\ProgramaType', $programa);
