 ...
 */
class Programa extends \GanttBundle\Entity\Programa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GanttBundle\\Entity\\Programa' . "\0" . 'id', '' . "\0" . 'GanttBundle\\Entity\\Programa' . "\0" . 'nombre', '' . "\0" . 'GanttBundle\\Entity\\Programa' . "\0" . 'agencia', '' . "\0" . 'GanttBundle\\Entity\\Programa' . "\0" . 'fondoslineas');
        }
    ...
    public function addFondoslinea(\GanttBundle\Entity\FondoLinea $fondoslineas)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addFondoslinea', array($fondoslineas));

        return parent::addFondoslinea($fondoslineas);
    }
    ...
    public function removeFondoslinea(\GanttBundle\Entity\FondoLinea $fondoslineas)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeFondoslinea', array($fondoslineas));

        return parent::removeFondoslinea($fondoslineas);
    }
    ...
    public function getFondoslineas()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFondoslineas', array());
